...
if (args.has("--disable")) {
  ...
  const saved = await saveEmailNotificationSettings({ enabled: true, toAddress, fromName: "Car Part Watcher", subjectPrefix: "[Car Part Watcher]", appBaseUrl: "https://car-part-watcher.andrewtryder.deno.net" });
